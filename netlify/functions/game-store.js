...
export function sanitizeGameConfig(config) {
  ...
  return {
    roomConfig: {
      ...
      finalInteractionMode: ["auto", "order"].includes(sourceRoomConfig.finalInteractionMode)
        ? sourceRoomConfig.finalInteractionMode
        : defaultGameConfig.roomConfig.finalInteractionMode,
      finalOrderPrompt: cleanString(sourceRoomConfig.finalOrderPrompt, defaultGameConfig.roomConfig.finalOrderPrompt),
      finalOrderErrorMessage: cleanString(
        sourceRoomConfig.finalOrderErrorMessage,
        defaultGameConfig.roomConfig.finalOrderErrorMessage,
      ),
      autoAdvanceEnabled: sourceRoomConfig.autoAdvanceEnabled === true,
      autoAdvanceDelaySeconds: Math.min(
        30,
        Math.max(
          0.5,
          cleanNumber(sourceRoomConfig.autoAdvanceDelaySeconds, defaultGameConfig.roomConfig.autoAdvanceDelaySeconds),
        ),
      ),
...
export function toPublicConfig(config, globalSettings = defaultGlobalSettings) {
  ...
  return {
    roomConfig: {
      ...
      finalInteractionMode: safeConfig.roomConfig.finalInteractionMode,
      finalOrderPrompt: safeConfig.roomConfig.finalOrderPrompt,
      finalOrderErrorMessage: safeConfig.roomConfig.finalOrderErrorMessage,
      autoAdvanceEnabled: safeConfig.roomConfig.autoAdvanceEnabled,
      autoAdvanceDelaySeconds: safeConfig.roomConfig.autoAdvanceDelaySeconds,
